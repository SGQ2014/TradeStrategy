...
if __name__ == '__main__':
    api = TqApi(auth=TqAuth("13738127551", "20091841"))
    klines = api.get_kline_serial("SHFE.rb2201", 1 * 60)
    # quote_near = api.get_quote("SHFE.rb2201")
    # quotes, _ = get_all_quotes('IH8888', ONE_MINUTE)
    czsc3 = Czsc(klines, 1, [1, 5, 30])
    czsc3.print_drawings()
    czsc3.print_segments(30)
    czsc3.print_maincenters(30)